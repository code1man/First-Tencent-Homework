...
%ADB% %DEVICE% install MyFirstUEProject-arm64.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell pm list packages com.YourCompany.MyFirstUEProject
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.YourCompany.MyFirstUEProject
...
%ADB% %DEVICE% shell pm grant com.YourCompany.MyFirstUEProject android.permission.READ_EXTERNAL_STORAGE >nul 2>&1
%ADB% %DEVICE% shell pm grant com.YourCompany.MyFirstUEProject android.permission.WRITE_EXTERNAL_STORAGE >nul 2>&1
